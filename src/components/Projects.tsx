...
//             whileHover={{ y: -6 }}
//             className="group rounded-2xl overflow-hidden border border-border bg-panel/60 flex flex-col transition-shadow hover:shadow-[0_0_40px_rgba(79,217,219,0.15)]"
//           >
